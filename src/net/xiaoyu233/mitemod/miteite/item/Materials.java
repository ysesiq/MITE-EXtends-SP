...
public class Materials extends Material {
    ...
    public static final Materials infinity = (Materials)new Materials(EnumEquipmentMaterials.infinity).setMetal(false).setHarmedByLava(false).setMinHarvestLevel(32767);
    ...
    public float getDurability() {
        if (this == wood) {
            ...
            return 34000000000000000000000000000000000000F;
        } else {
            Minecraft.setErrorMessage("getDurability: unhandled material " + this.name);
            return 0.0F;
        }
    }
