...
//    }
    ...
    public boolean canEnchantItem(Item item) {
        if (item instanceof ItemTool) {
            ...
            if (!(material == Materials.infinity || material == Materials.enchant || material == Materials.vibranium || material == Materials.mithril || material == Materials.adamantium || material == Materials.iron || material == Materials.ancient_metal)) {
                return false;
            }
        }
