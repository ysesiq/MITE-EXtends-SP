...
public static final Enchantment CRIT = new EnchantmentCrit(8,yq.c, 10);
    ...
    public static final Enchantment enchantmentUnassailable = new EnchantmentUnassailable(37, yq.d,30);

    public static List<Enchantment> individualEnchantments = new ArrayList<>();
    public static void registerEnchantments(){
        Enchantments.registerEnchantmentsUnsafe(enchantmentFixed, CRIT, EXTEND, EMERGENCY, CONQUEROR, BEHEADING, enchantmentChain, EnchantmentForge, enchantmentRangeAttack, enchantmentUnassailable);
    }
