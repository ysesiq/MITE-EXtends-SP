      ...
      for(int attempt = 0; attempt < 16; ++attempt) {
         ...
         if (entity_class == EntityCreeper.class) {
            ...
            if (entity_class == EntityZombieDoor.class) {
               if (!check_depth || y <= 40)
                  if(this.isUnderworld() && this.rand.nextInt(20) == 0 && this.rand.nextFloat() < 0.5F) {
...
//                     return EntityZombieDoorLord.class;
            ...
            if (entity_class == EntityZombieMiner.class) {
               if (!check_depth || is_blood_moon_up)
                  return entity_class;
            }
//            if (entity_class == EntityZombieDoorLord.class) {
//                  return entity_class;
//            }
            if (entity_class == EntityZombieDoorDeep.class) {
               if (!check_depth || y <= 1)
                  return entity_class;
            }
   ...
   public void tick() {
      ...
      if (Configs.wenscConfig.firstDayLongerDayTime.ConfigValue && this.getDayOfOverworld() == 1 && this.getTotalWorldTime() < 12000L) {
