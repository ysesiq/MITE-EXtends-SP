...
public class EntityGhastTrans extends EntityFlying implements IMonster {
   ...
   protected void applyEntityAttributes() {
      ...
      super.getEntityAttribute(GenericAttributes.maxHealth).setAttribute(15.0D + (day / 16));
   }
...
//               }
   ...
   @Overwrite
    protected void dropFewItems(boolean z, DamageSource damageSource) {
        ...
        if (damageSource.isFireballFromPlayer() && num_drops < 1) {
            num_drops = 1;
        }
        ...
        dropItem(Items.voucherGhast.itemID, 1);
    }
