...
public class EnchantmentUtil {
    ...
    private static Map<Integer, EnchantmentInstance> mapEnchantmentData(int enchantment_levels, ItemStack item_stack) {
        Item item = item_stack.getItem();
        boolean is_enhance = item.getHardestMetalMaterial() == Materials.vibranium || item.getHardestMetalMaterial() == Materials.enchant || item.getHardestMetalMaterial() == Materials.infinity;
