...
public class RegisterHelper {
    ...
    public static void registerPrice() {
        ...
        Items.doorAncientMetal.setSoldPrice(80D);
...
//        Items.netherQuartz.setBuyPrice(2D);
        ...
        Items.getItem(Blocks.blockColorfulWall.blockID).setBuyPrice(0.375D).setSoldPrice(0.375D);
        ...
        Items.getItem(Blocks.netherrack.blockID).setSoldPrice(1D);
        // 开始注入商品价格配置文件
