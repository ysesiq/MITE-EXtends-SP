...
public class EntitySkeletonShadow extends EntitySkeleton {
    ...
    public EntitySkeletonShadow(World par1World) {
        super(par1World);
    ...
    protected void applyEntityAttributes() {
        ...
        this.setEntityAttribute(GenericAttributes.attackDamage, 15.0 + day / 15.0D);
        this.setEntityAttribute(GenericAttributes.maxHealth, 48.0 + day / 6.0D);
    }
