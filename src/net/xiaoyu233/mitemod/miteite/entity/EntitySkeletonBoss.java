...
public class EntitySkeletonBoss extends EntitySkeleton implements IBossbarEntity {
    ...
    private Enchantment [] enhanceSpecialBookList = new Enchantment[] {Enchantment.protection, Enchantment.sharpness,  Enchantment.fortune, Enchantment.harvesting, Enchantments.EXTEND, Enchantment.efficiency, Enchantment.vampiric, Enchantment.butchering, Enchantment.featherFalling, Enchantments.EnchantmentForge};
    private Enchantment [] nonLevelsBookList = new Enchantment[] {Enchantments.enchantmentFixed, Enchantments.enchantmentChain, Enchantments.EMERGENCY, Enchantments.enchantmentRangeAttack, Enchantments.enchantmentUnassailable};
    ...
    protected void dropFewItems(boolean recently_hit_by_player, DamageSource damage_source) {
        if (recently_hit_by_player){
            ...
            this.dropItemStack(new ItemStack(Items.diamond, 10 + (int) (day / 10)));
