...
public class Blocks extends Block {
    ...
    public static final Block vibraniumDoor = ReflectHelper.createInstance(BlockDoor.class, new Class[]{int.class, Material.class}, 275, Materials.vibranium).setStepSound_(soundMetalFootstep);
    public static final BlockOreBlock blockInfinity = new BlockOreBlock(276, Materials.infinity);
    public static final BlockAnvil anvilInfinity = ReflectHelper.createInstance(BlockAnvil.class, new Class[]{int.class, Material.class}, 277, Materials.infinity);
    public static final Block volcanoStone = new BlockVolcanoStone(278);
    public static final BlockSand volcanoSand = (BlockSand) new BlockSand(279).setBlockHardness(0.4F);
    public static final Block volcanoCobblestone = ReflectHelper.createInstance(Block.class, new Class[]{int.class, Material.class, BlockConstants.class}, 280, Materials.stone, new BlockConstants())
            .setCreativeTab(CreativeModeTab.tabBlock).setBlockHardness(2.0F);
    public static final Block volcanoAshes = ReflectHelper.createInstance(Block.class, new Class[]{int.class, Material.class, BlockConstants.class}, 281, Materials.sand, new BlockConstants())
            .setCreativeTab(CreativeModeTab.tabBlock).setStepSound_(soundSandFootstep);
    public static final Block volcanoEmeraldOre = new BlockOre(282, Material.emerald, 3).setBlockHardness(4.0F);
    public static final Block volcanoMithrilOre = new BlockOre(283, Material.mithril, 3).setBlockHardness(4.0F);
    public static final Block volcanoDiamondOre = new BlockOre(284, Material.diamond, 3).setBlockHardness(4.0F);
    public static final BlockFu fuDaoLe = new BlockFu(285, Material.wood);
    public static final Block blockColorfulWall = new BlockColorfulWall(286, blockColorful, 0);
    //    public static final Block blockColorfulSlab = new BlockColorfulSlab(287, Material.stone);
//    public static final Block blockColorfulDoubleSlab = new BlockColorfulDoubleSlab(288, (BlockSlab) blockColorfulSlab);
    public static final Block blockColorfulSlab = (ReflectHelper.createInstance(BlockColorfulSlab.class, new Class[]{int.class, Material.class}, 287, Materials.stone)).setUnlocalizedName("blockColorfulSlab");
    public static final Block blockColorfulDoubleSlab = (ReflectHelper.createInstance(BlockColorfulSlab.class, new Class[]{int.class, Material.class}, 288, Materials.stone)).setUnlocalizedName("blockColorfulSlabDouble");
//    public static final Block volcanoGravel = (ReflectHelper.createInstance(BlockVolcanoGravel.class, new Class[] {int.class,Material.class}, getNextBlockID(), Materials.sand)).setUnlocalizedName("blockVolcanoGravel");
//    public static final Block blockColorfulSlab = (ReflectHelper.createInstance(BlockColorfulSlab.class, new Class[] {int.class,Material.class}, 287, Materials.stone)).setUnlocalizedName("blockColorfulSlab");
    ...
    public static void registerBlocks() {
        ...
        registerItemBlock(blockColorfulSlab, "colorful_slab");
        registerItemBlock(blockColorfulDoubleSlab, "colorful_slab_double");
        ...
        registerAnvil(anvilInfinity, "anvil_infinity");
        anvilInfinity.stepSound = Block.soundAnvilFootstep;
        registerItemBlock(blockInfinity, "block_infinity");
        ...
        //       registerItemBlock(volcanoGravel,"volcano/volcano_gravel");
        ...
        registerItemBlock(fuDaoLe, "china_fu");
    }
    ...
    public static void registerRecipes(RecipeRegister register) {
        register.registerShapelessRecipe(new ItemStack(blockColorful, 6, 0), true, new ItemStack(blockColorfulWall, 8, 0));
        ...
        for (int i = 0; i < 15; ++i) {
            ...
            register.registerShapelessRecipe(new ItemStack(blockColorfulWall, 9, i + 1), true, new ItemStack(blockColorfulWall, 9, i));
        }
        ...
        register.registerShapelessRecipe(new ItemStack(blockColorfulWall, 9, 0), true, new ItemStack(blockColorfulWall, 9, 15));
        ...
        register.registerShapelessRecipe(new ItemStack(blockInfinity), true,
                ...
                infinityingot, netherStar, infinityingot,
                infinityingot, infinityingot, infinityingot
        );
        ...
        RecipesFurnace.smelting().addSmelting(Blocks.fancyRed.blockID, new ItemStack(Items.fancyRed));
        RecipesFurnace.smelting().addSmelting(Blocks.volcanoEmeraldOre.blockID, new ItemStack(Item.emerald));
        RecipesFurnace.smelting().addSmelting(Blocks.volcanoDiamondOre.blockID, new ItemStack(Item.diamond));
        RecipesFurnace.smelting().addSmelting(Blocks.volcanoMithrilOre.blockID, new ItemStack(Item.ingotMithril));
...
//    static {
//        Item.itemsList[blockColorfulSlab.blockID] = (new ItemColorfulStep((BlockColorfulSlab) blockColorfulSlab, (BlockColorfulDoubleSlab) blockColorfulDoubleSlab, false)).setUnlocalizedName("colorfulSlab");
//        Item.itemsList[blockColorfulDoubleSlab.blockID] = (new ItemColorfulStep((BlockColorfulSlab) blockColorfulSlab, (BlockColorfulDoubleSlab) blockColorfulDoubleSlab, true)).setUnlocalizedName("colorfulSlab");
//    }
}